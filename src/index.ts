...
interface Order {
  ...
  // Place a limit order
app.post("/order", (req: express.Request, res: express.Response) => {
  ...
  app.get("/depth", (req: express.Request, res: express.Response) => {
    const depth: {
      [price: string]: {
        type: "bid" | "ask",
        quantity: number,
  ...
  app.get("/balance/:userId", (req: express.Request, res: express.Response) => {
  ...
  app.get("/quote", (req: express.Request, res: express.Response) => {
    // TODO: Assignment
  });
